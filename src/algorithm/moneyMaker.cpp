...
Json moneyMaker::getFinalData() const {
	Json result;

	result.push_back(getFullCash());
	result.push_back(stats.profitableOrder);
	...
	if (cash > startCash) {
		auto profit = cash - startCash;
		auto profitPercent = profit / startCash * 100;
		result.push_back(profitPercent / maxLossPercent);
		result.push_back(profit / stats.summaryLoss);
	}
	else {
		result.push_back(0.0);
		result.push_back(0.0);
	}
	result.push_back(stats.touchTrendOrder);
	result.push_back(stats.breakTrendOrder);
	result.push_back(indicators::atrTypeToString(atrType));
	result.push_back(atrSize);
	result.push_back(stFactor);
	result.push_back(dealPercent);
	result.push_back(leverage);
	result.push_back(activationPercent);
	result.push_back(stopLossPercent);
	result.push_back(minimumProfitPercent);
	result.push_back(dynamicStopLossModule.dynamicSLPercent);
	result.push_back(dynamicStopLossModule.trendMode);
	result.push_back(trendTouchOpenerModule.activationWaitMode);
	result.push_back(trendBreakOpenerModule.enabled);
	result.push_back(trendBreakOpenerModule.activationWaitMode);
	result.push_back(trendBreakOpenerModule.alwaysUseNewTrend);
	result.push_back(activationWaiterModule.resetAllowed);
	result.push_back(activationWaiterModule.activationWaitRange);
	result.push_back(activationWaiterModule.fullCandleCheck);
	result.push_back(stopLossWaiterModule.enabled);
	result.push_back(stopLossWaiterModule.resetAllowed);
	result.push_back(stopLossWaiterModule.stopLossWaitRange);
	result.push_back(stopLossWaiterModule.fullCandleCheck);
